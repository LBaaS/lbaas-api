...
CREATE TABLE devices ( 
    ...
    name         VARCHAR(64)          NOT NULL,                  # admin assigned device name
    ...
    type         VARCHAR(64)          NOT NULL,                  # type of device, e.g. 'HAProxy'
    status       VARCHAR(64)          NOT NULL,                  # status of device 'OFFLINE', 'ONLINE', 'ERROR'
    PRIMARY KEY (id)
);
